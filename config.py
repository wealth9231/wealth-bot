...
# ==================== 交易配置 ====================
SYMBOLS = ["BTC/USDT", "ETH/USDT", "SOL/USDT", "BNB/USDT", "DOGE/USDT", "TRX/USDT"]  # 交易对列表
TIMEFRAME = "15m"            # K线周期
...
RSI_OVERSOLD = 42           # RSI超卖阈值 (基础值，会根据布林带宽度动态调整)
RSI_OVERBOUGHT = 65         # RSI超买阈值 (降低阈值，更激进止盈)
RSI_OS_WIDE = 25            # 宽幅趋势时的RSI超卖阈值 (防止钝化)
